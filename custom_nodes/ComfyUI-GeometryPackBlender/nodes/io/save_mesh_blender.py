...
class SaveMeshBlender:
    """Temporary save mesh stub for GeometryPackBlender standalone validation."""
    ...
    def save_mesh(self, trimesh, file_path, format="obj"):
        ...
        print(f"[SaveMesh_Blender] Saved: {full_path} ({len(trimesh.vertices)} vertices, {len(trimesh.faces)} faces)")
        return (full_path,)


NODE_CLASS_MAPPINGS = {
    "SaveMesh_Blender": SaveMeshBlender,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "SaveMesh_Blender": "Save Mesh (Blender Stub)",
}
