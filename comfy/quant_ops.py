...
def grouped_int8_convrot_linear_packed(
    ...
    *,
    ...
    if not _CK_AVAILABLE:
        raise RuntimeError("Packed INT8 ConvRot expert operations require comfy-kitchen")
    return ck.grouped_int8_convrot_linear_packed(
        x,
        expert_indptr,
        weight,
        weight_scale,
...
def grouped_convrot_w4a8_linear_packed(
    ...
    *,
    ...
    if not _CK_AVAILABLE:
        raise RuntimeError("Packed W4A8 ConvRot expert operations require comfy-kitchen")
    return ck.grouped_convrot_w4a8_linear_packed(
        x,
        expert_indptr,
        weight,
        weight_scale,
