"""SeedVR2 color correction: AdaIN (Huang&Belongie 2017), LAB (Reinhard 2001), wavelet (StableSR/GIMP), sRGB/CIELAB per IEC 61966-2-1 / CIE 15."""
...
def lab_color_transfer(
    ...
    rgb_to_xyz_matrix = torch.tensor(SRGB_TO_XYZ_D65, dtype=torch.float32, device=device)
    xyz_to_rgb_matrix = torch.tensor(XYZ_TO_SRGB_D65, dtype=torch.float32, device=device)
