...
# Import attention_split from split_q module
from comfy.split_q.split_q_attention import attention_split
...
register_attention_function("split", attention_split)  # Now imported from comfy.split_q.split_q_attention
